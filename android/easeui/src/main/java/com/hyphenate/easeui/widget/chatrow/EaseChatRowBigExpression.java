    ...
    public void onSetUpView() {
        ...
        if (emojicon != null) {
            ...
            if (emojicon.getBigIcon() != 0) {
                Glide.with(activity).load(emojicon.getBigIcon()).apply(options.placeholder(R.drawable.ease_default_expression)).into(imageView);
            } else if (emojicon.getBigIconPath() != null) {
                Glide.with(activity).load(emojicon.getBigIconPath()).apply(options.placeholder(R.drawable.ease_default_expression)).into(imageView);
            } else {
