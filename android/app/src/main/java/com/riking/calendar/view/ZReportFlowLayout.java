...
public class ZReportFlowLayout extends ViewGroup {

    private int line_height;

    public ZReportFlowLayout(Context context) {
        super(context);
    }

    public ZReportFlowLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
