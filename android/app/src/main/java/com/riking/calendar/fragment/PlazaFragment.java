...
public class PlazaFragment extends Fragment implements BGANinePhotoLayout.Delegate,EasyPermissions.PermissionCallbacks,BGAOnRVItemClickListener, BGAOnRVItemLongClickListener {
...
//                }
    ...
    private void addNetImageTestData() {
        ...
        mMomentAdapter.addMoreData(moments);
//        mMomentAdapter.setData(moments);
    ...
    private class MomentAdapter extends BGARecyclerViewAdapter<Moment> {
        ...
        protected void fillData(BGAViewHolderHelper helper, int position, Moment moment) {
            ...
            ninePhotoLayout.setDelegate(PlazaFragment.this);
