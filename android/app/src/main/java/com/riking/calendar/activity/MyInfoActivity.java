...
public class MyInfoActivity extends AppCompatActivity {
    ...
    ImageView myPhoto;
    AppUserResp u = ZPreference.getCurrentLoginUser();
    //phone number
...
//                        Toast.makeText(MyInfoActivity.this, "Begin Parse Data", Toast.LENGTH_SHORT).show();
...
//                    Toast.makeText(MyInfoActivity.this, "Parse Succeed", Toast.LENGTH_SHORT).show();
                ...
                case MSG_LOAD_FAILED:
                    Toast.makeText(MyInfoActivity.this, "Parse Failed", Toast.LENGTH_SHORT).show();
                    break;
    ...
    public void clickUserInfo(final View view) {
        ZGoto.to(UserInfoActivity.class);
    }
...
//        Bitmap bitMap = BitmapFactory.decodeResource(getResources(), R.drawable.cat_1);
    ...
    private void showPickerView() {
        ...
        final MyInfoActivity.UpdateUserInfoCallBack callBack = new MyInfoActivity.UpdateUserInfoCallBack() {
            @Override
    ...
    /*    phoneNumberLayout.setOnClickListener(new ZClickListenerWithLoginCheck() {
            ...
            public void click(View v) {
                changeCompanyDialog(3, currentUser.phone, new MyInfoActivity.UpdateUserInfoCallBack() {
                    @Override
        ...
        emailLayout.setOnClickListener(new ZClickListenerWithLoginCheck() {
            ...
            public void click(View v) {
               ...
               /* changeCompanyDialog(1, currentUser.email, new MyInfoActivity.UpdateUserInfoCallBack() {
                    @Override
                    public void newValue(final String newValue) {
      ...
      /*  companyLayout.setOnClickListener(new ZClickListenerWithLoginCheck() {
            @Override
            public void click(View v) {
                changeCompanyDialog(0, currentUser.companyName, new MyInfoActivity.UpdateUserInfoCallBack() {
                    @Override
                    public void newValue(final String newValue) {
...
//                final String positionName = i.getPickerViewText();
     ...
     * @param callBack
     */
    private void changeCompanyDialog(final int type, String initValue, final MyInfoActivity.UpdateUserInfoCallBack callBack) {
