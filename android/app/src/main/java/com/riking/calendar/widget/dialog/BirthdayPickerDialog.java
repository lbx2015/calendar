...
public class BirthdayPickerDialog extends BottomSheetDialog implements AbstractWheelPicker.OnWheelChangeListener {
    ...
    public BirthdayPickerDialog(@NonNull Context context) {
        super(context);
        setContentView(R.layout.pick_birthday_wheel);
    ...
    public BirthdayPickerDialog(@NonNull Context context, int theme) {
        super(context, theme);
    }

    protected BirthdayPickerDialog(@NonNull Context context, boolean cancelable, OnCancelListener cancelListener) {
