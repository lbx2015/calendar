...
public class SearchDialog extends AppCompatDialog {
    ...
    private InitListener mInitListener = new InitListener() {
        ...
        public void onInit(int code) {
            Log.d("zzw", "SpeechRecognizer init() code = " + code);
    ...
    private RecognizerListener mRecognizerListener = new RecognizerListener() {
        ...
        public void onResult(RecognizerResult results, boolean isLast) {
            Log.d("zzw", results.getResultString());
            if (mTranslateEnable) {
...
//        mIat.setParameter(SpeechConstant.ASR_AUDIO_PATH, getApplicationContext().getFilesDir() + "/iat.wav");
