...
- (void)setDatePickerWithMaxDate:(NSDate *)maxDate
    ...
    if (fixedValueDate!=nil) {
        ...
        self.timePickerView.fixedValueDate = fixedValueDate;
    }
}
...
- (void)setPickViewTopWithLeftButtonImage:(UIImage *)leftImage
                         rightButtonImage:(UIImage *)rightButtonImage{
    
    if (leftImage) {
        self.timePickerView.topView.leftButtonImage = leftImage;
    }
    
    if (rightButtonImage) {
        self.timePickerView.topView.rightButtonImage = rightButtonImage;
    }
