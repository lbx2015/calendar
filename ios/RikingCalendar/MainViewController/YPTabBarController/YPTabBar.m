...
- (void)updateItemsFrame {
    ...
    [self.bglineView removeFromSuperview];
...
{
    if (!_bglineView) {
        _bglineView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, self.bounds.size.width, 0.5)];
        _bglineView.backgroundColor = [UIColor lightGrayColor];
    }
