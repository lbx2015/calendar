...
public interface ReportSubmitCaliberRepo
	...
	@Transactional
	@Modifying
	@Query("update ReportSubmitCaliber set isDelete = '0'  where id in ?1")
	...
	Set<String> findByWorkDatefromReportId(Integer week, Integer ten, Integer month, Integer season, Integer halfYear,
			Integer Year);
