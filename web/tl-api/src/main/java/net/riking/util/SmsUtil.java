...
public class SmsUtil {
	...
	public SendSmsResponse sendSms(String phone, String verifyCode)
		...
		AliSme alims = new AliSme(phone, config.getSignName(),
				config.getCommonTemplateCode(), verifyCode);
		...
		request.setTemplateParam(
				"{\"code\":\"" + alims.getVerificationCode() + "\"}");
	 ...
	 * @throws Exception
	 */
	public boolean checkValidCode(String phone, String verifyCode)
		...
		if (StringUtils.isNotBlank(phone)
			...
			if (StringUtils.isNotBlank(code)) {
				...
				throw new NullPointerException(
						CodeDef.EMP.CHECK_CODE_TIME_OUT + "");
			}
		} else {
			throw new NullPointerException("phone={" + phone
					+ "} and verifyCode={" + verifyCode + "} is empty");
		}
		return false;
	}
