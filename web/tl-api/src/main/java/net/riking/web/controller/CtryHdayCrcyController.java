...
public class CtryHdayCrcyController {
	...
	@ApiOperation(value = "得到<所有>", notes = "POST")
	...
	public Resp addMore_(HttpServletRequest request) {
		...
		if(list!=null && list.size()>0){
			for (ModelPropDict dict : list) {
				dict.setClazz("T_CTRY_HDAY_CRCY");
				dict.setField("HDAY");
			}
