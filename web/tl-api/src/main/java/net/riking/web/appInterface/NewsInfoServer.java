...
public class NewsInfoServer {
	...
	// List<NewsComment> newsCommentInfoList =
	// newsCommentInfoRepo.findByNewsId(commonParams.getNewsId(),
	// new PageRequest(0, 30));
	//
	// // 评论列表
	...
	// nCommentReplyInfoRepo.findByNewsCommentId(newsCommentInfoNew.getId());
	// // 回复列表
