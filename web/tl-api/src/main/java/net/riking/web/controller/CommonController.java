...
//			fileName = appUserService.savePhotoFile(mFile, Const.TL_TEMP_PHOTO_PATH);
			String folderPath = FileUtils.getAbsolutePathByProject(Const.TL_TEMP_PHOTO_PATH);
...
//		projectPath = projectPath + "/" + Const.TL_TEMP_PHOTO_PATH;
		String photoUrl = FileUtils.getPhotoUrl(Const.TL_TEMP_PHOTO_PATH+fileName, this.getClass());
		Data data = new Data(photoUrl , fileName);
